 ...
 * @apiSuccess {Object} [role=undefined] Assignable or given roles that
 * permits(or give access rights) to a party.
 * @apiSuccess {Object[]} [members=undefined] List of parties belongs to
 * this party.
 ...
 * permits(or give access rights) to a party.
 * @apiSuccess {Object[]} [data.members=undefined] List of parties belongs to
 * this party.
 ...
 * @apiUse AuthorizationHeaderErrorExample
 */
router.post(PATH_NOTIFICATION, function postNotification(request, response,
  next) {
  ...
  Party
    .notify(body, function onPostNotification(error, results) {
