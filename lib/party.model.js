...
const PARTY_GROUPS = getStrings('PARTY_GROUPS', [
  'Ambulance Services', 'Community Members', 'Community Organizations',
  'Government Agencies', 'Hospitals', 'Utilities',
  'Humanitarian Organizations', 'International Organizations',
  'Non-governmental Organizations', 'Private Organizations',
  'Scouts', 'Religious Institutions', 'Defense & Security',
  'Fire & Rescue', 'Voluntary Organizations', 'Unknown'
]);
...
/* export party model */
module.exports = model(PARTY_MODEL_NAME, PartySchema);
